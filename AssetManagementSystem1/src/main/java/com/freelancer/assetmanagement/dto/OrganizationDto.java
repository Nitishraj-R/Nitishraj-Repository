...
public class OrganizationDto extends BaseModel {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2670876136769624178L;
...
//	private List<Asset> asset;
	...
	public String toString() {
		return "OrganizationDto [organizationId=" + organizationId + ", organizationCode=" + organizationCode + ", name="
